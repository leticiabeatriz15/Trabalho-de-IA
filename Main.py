...
print(f"\033[1mTempo de execução da busca em largura: {duracao:.4f} segundos\033[0m")
...
tempoFim = time.time()
duracao = tempoFim - tempoInicio 
print(f"\033[1mTempo de execução da busca em profundidade: {duracao:.4f} segundos\033[0m")
...
tempoFim = time.time()
duracao = tempoFim - tempoInicio 
print(f"\033[1mTempo de execução da busca em profundidade iterativa: {duracao:.4f} segundos\033[0m")
...
tempoFim = time.time()
duracao = tempoFim - tempoInicio
print(f"\033[1mTempo de execução da busca gulosa: {duracao:.4f} segundos\033[0m")
...
tempoFim = time.time()
duracao = tempoFim - tempoInicio
print(f"\033[1mTempo de execução da busca estrela: {duracao:.4f} segundos\033[0m")